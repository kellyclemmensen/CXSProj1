...
- [Metricbeats Playbook](https://github.com/kellyclemmensen/CXSProj1/blob/main/YAML/metricbeat.yml) | [Filebeats Configuration File](https://github.com/kellyclemmensen/CXSProj1/blob/main/YAML/metricbeat-config.yml) Configuration files were edited to reflect the IP address of the ELK server. 
